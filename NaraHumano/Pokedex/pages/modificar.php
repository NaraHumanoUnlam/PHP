...
<section>
    <article class="flex flex-col justify-center items-center">
        <h2 class="text-3xl text-red-400 m-5">Modificar pokemon</h2>
        <form action="modificar.php" method="post" enctype="application/x-www-form-urlencoded">
            ...
            <input type="submit" value="Modificar pokemon" class="bg-blue-200 w-30 h-25 p-2 rounded hover:bg-blue-400 text-black">
            <?php
            ...
            if($pnombre != "" && $tipo!= "") {
                ...
                if($imagen!= ""){
                    ...
                    modificarImagen($imagen,$numero);
                }
                modificarPokemon($numero,$numero,$pnombre,$tipo,$descripcion);
                echo "</div>";
            }
